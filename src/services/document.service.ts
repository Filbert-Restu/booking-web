...
export const documentService = {
    ...
    async submitDocument(id: number): Promise<Document> {
        const response = await api.post<SingleDocumentResponse>(`/documents/${id}/submit`);
        return response.data.data;
    },
     ...
     */
    async approveDocument(id: number, note?: string): Promise<Document> {
     ...
     */
    async reviseDocument(id: number, targetUserId: number, note: string): Promise<Document> {
        const response = await api.post<SingleDocumentResponse>(
            `/documents/${id}/revise`,
