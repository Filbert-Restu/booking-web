...
function RouteComponent() {
  ...
  const applyDataToLocalState = (data: any) => {
    ...
    if (data.ketua_pelaksana_nama)
      setKetuaPelaksanaNama(data.ketua_pelaksana_nama);
    if (data.ketua_pelaksana_nim)
      setKetuaPelaksanaNim(data.ketua_pelaksana_nim);
  ...
  const handleNext = async (e: React.FormEvent) => {
    ...
    if (isFromReservation) {
      ...
      // ====== DEBUG: CEK DATA YANG DISIMPAN KE CONTEXT ======
      console.log(
        '💾 [DETAIL-TEMPAT] Data yang disimpan ke context:',
    ...
    try {
      ...
      // ====== DEBUG: CEK DATA YANG DISIMPAN KE CONTEXT (NEW BOOKING) ======
      console.log('💾 [DETAIL-TEMPAT] Document created, ID:', document.id);
      console.log('💾 [DETAIL-TEMPAT] Data saved to context:', {
        document_id: document.id,
        room_id: selectedRoomId,
        ketua_pelaksana_nama: ketuaPelaksanaNama,
        ketua_pelaksana_nim: ketuaPelaksanaNim,
