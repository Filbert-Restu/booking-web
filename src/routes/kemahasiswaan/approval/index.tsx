...
function RouteComponent() {
  ...
  const handleUpdateKemahasiswaan = (
    id: number,
  ...
  return (
    <div className='space-y-6'>
      <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
        <div>
          <h1 className='text-2xl font-bold text-gray-900'>Approval Kemahasiswaan</h1>
          <p className='text-gray-600 mt-1'>Kelola persetujuan peminjaman ruang oleh Kemahasiswaan.</p>
        </div>
                ...
                <TableCell className='text-center'>
                  <div className='flex items-center justify-center gap-2'>
                    <Button
                      ...
                      onClick={() => handleUpdateKemahasiswaan(item.id, 'approved')}
                      disabled={item.approvalKemahasiswaan === 'approved'}
                    >
                    ...
                    <Button
                      ...
                      variant='destructive'
                      className='flex items-center gap-1'
                      onClick={() => handleUpdateKemahasiswaan(item.id, 'rejected')}
                      disabled={item.approvalKemahasiswaan === 'rejected'}
                    >
